...
- ผู้จัดการ Expense กด `Reset to Draft` ได้เมื่อเอกสารอยู่ที่ `submit` หรือ `approve`
...
### ผู้จัดการ Expense เมื่อต้องดึงเอกสารกลับมาแก้

1. เปิด `Expense Sheet`
2. ตรวจว่าเอกสารอยู่ที่ `submit` หรือ `approve`
3. กด `Reset to Draft`
4. ตรวจข้อความใน `Chatter`
5. ให้พนักงานหรือผู้เกี่ยวข้องกลับไปแก้ข้อมูลแล้วส่งใหม่
...
- ปุ่ม `Reset to Draft` ใช้ไม่ได้ถ้าเอกสารยังเป็น `draft`, โพสต์บัญชีแล้ว หรือคืนเงินสดแล้ว
